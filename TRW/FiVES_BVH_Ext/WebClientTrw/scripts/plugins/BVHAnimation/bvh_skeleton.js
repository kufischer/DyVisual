...
(function (){
    ...
    var BVHSkeleton = function() {
        ...
        this.joints = new Array(this.jointNum);
        ...
        this.joints[42].BVHName = "None";
        this.joints[42].XML3DName = "LeftToolEndSite";

        this.joints[43].BVHName = "None";
        this.joints[43].XML3DName = "RightToolEndSite";

        //Initialize translation data filled with [0 0 0] and quaternion data with [0 0 0 1]
        this.translationData = new Float32Array(this.jointNum*3);


        this.quaternionData = new Float32Array(this.jointNum*4);
        ...
        //Initialize left tool end site and right tool end site
        this.translationData[42*3] = 9.55928;
        this.translationData[42*3+1] = -0.145352;
        this.translationData[42*3+2] = 5.186424;

        this.translationData[43*3] = 9.55928;
        this.translationData[43*3+1] = 0.145352;
        this.translationData[43*3+2] = 5.186424;
